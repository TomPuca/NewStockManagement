class PaintManager {
  ...
  initPaintTools() {
    document.getElementById('brush-mode').addEventListener('click', () => {
      if (this.currentTool === 'brush') {
        ...
        this.setActiveTool('brush', i18n[currentLang].brush_mode);
    ...
    document.getElementById('eraser-mode').addEventListener('click', () => {
      if (this.currentTool === 'eraser') {
        ...
        this.setActiveTool('eraser', i18n[currentLang].eraser);
    ...
    document.getElementById('text-mode').addEventListener('click', () => {
      if (this.currentTool === 'text') {
        ...
        this.setActiveTool('text', i18n[currentLang].insert_text);
        this.brushColor = document.getElementById('brush-color').value;
      }
    });
  ...
  startTextPlacement() {
    ...
    if (!text) {
      alert(i18n[currentLang].enter_text);
      return;
    }
    ...
    // Add visual feedback
    setCanvasTitle(i18n[currentLang].click_to_place);
  ...
  placeText(e) {
    ...
    this.isTextPlacementMode = false;
    this.canvas.classList.remove('text-placement-mode');
    setCanvasTitle(i18n[currentLang].drag_to_adjust);
  }
