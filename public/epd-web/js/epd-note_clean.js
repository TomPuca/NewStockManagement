  ...
  function renderPreviewCanvas() {
    ...
    // Top: Analog Clock (Center at 65, 65, radius 58) - Shifted UP by 10px
    drawAnalogClock(ctx, LEFT_W / 2, 65, 58);

    // Bottom: Event Countdown
    drawEventCountdown(ctx, LEFT_W / 2, FULL_H * 0.72);
  }
  ...
  function getWeatherDescVi(weatherId) {
    const desc = {
"Không rõ",
"Nắng",
"Nhiều mây",
...
"Cát bụi"
  ...
  window.clearNoteEvent = function () {
